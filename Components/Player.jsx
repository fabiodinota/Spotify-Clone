  ...
  return (
    <div className='h-24 bg-gradient-to-b from-black to-gray-900 text-white  grid grid-cols-3 text-xs md:text-base px-2 md:px-8'>
        <div className='flex items-center space-x-4 '>
            <Image className='hidden md:inline' width={40} height={40} src={songInfo?.album.images?.[0]?.url} alt="" />
            <div>
                <h3> {songInfo?.name}</h3>
        ...
        <div className='flex items-center justify-evenly'>
            ...
            {isPlaying ? (
                <PauseIcon className='button1' onClick={handlePlayPause} />
            ) : (
                <PlayIcon className='button1' onClick={handlePlayPause} />
            )}
